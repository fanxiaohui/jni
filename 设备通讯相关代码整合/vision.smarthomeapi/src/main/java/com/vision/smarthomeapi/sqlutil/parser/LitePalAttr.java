...
package com.vision.smarthomeapi.sqlutil.parser;
...
import com.vision.smarthomeapi.sqlutil.util.SharedUtil;
...
public final class LitePalAttr {
	...
	public List<String> getClassNames() {
		if (classNames == null) {
			...
			classNames.add("com.vision.smarthomeapi.sqlutil.model.Table_Schema");
