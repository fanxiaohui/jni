...
/**
 * 墙插
 * Created by zhaoqing on 2016/1/24.
 */
public class WallSocket extends SmartDevice implements IDeviceBuzzer {
    ...
    public void parseNetworkData(boolean isRead, byte[] data, int msgID) {
        ...
        OutPutMessage.LogCatInfo("墙插接收数据", "(设备MAC)--> :" + getSmartDeviceLogic().getDeviceMac() + ",(消息ID)-->" + Integer.toHexString(msgID) + ",(数据内容)-->" + ByteUtil.byteArrayToHexString(data, true));
