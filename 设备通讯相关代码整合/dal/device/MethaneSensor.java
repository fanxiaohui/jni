 ...
 */
public class MethaneSensor extends SmartDevice implements IDeviceBuzzer {
    ...
    public void parseNetworkData(boolean isRead, byte[] data, int msgID) {
        OutPutMessage.LogCatInfo("甲烷接收数据", "(设备MAC)--> :" +  getSmartDeviceLogic().getDeviceMac() + ",(消息ID)-->" + Integer.toHexString(msgID) + ",(数据内容)-->" + ByteUtil.byteArrayToHexString(data, true));
