...
class SaveHandler extends DataHandler {
	 ...
	 * {@link org.litepal.crud.DataSupport#saveAll(Collection)}. Each model in the collection
	 ...
	 * {@link #beforeSave(org.litepal.crud.DataSupport, List, ContentValues)} will be called to
	 * put the values for ContentValues. When the model is saved,
	 * {@link #afterSave(org.litepal.crud.DataSupport, List, long)} will be called to do stuffs
