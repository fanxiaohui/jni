...
package com.vision.smarthomeapi.sqlutil.crud;
...
import com.vision.smarthomeapi.sqlutil.LitePalBase;
import com.vision.smarthomeapi.sqlutil.crud.model.AssociationsInfo;
import com.vision.smarthomeapi.sqlutil.exceptions.DataSupportException;
...
abstract class DataHandler extends LitePalBase {
	...
	protected String getIntermediateTableName(DataSupport baseObj, String associatedTableName) {
		return BaseUtility.changeCase(DBUtility.getIntermediateTableName(baseObj.getTableName(),
				associatedTableName));
	}
