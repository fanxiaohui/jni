...
public class SmartHomeHead {
	...
	/**
	 * 添加普通数据包头信息
	 * @param data 需要添加包头的数据和相关信息参见{@link com.smarthome.head.SmartHomeData}
	 * @return 添加完成后头的数据
	 */
     ...
     * @return 无论解析是否成功都会返回 {@link com.smarthome.head.SmartHomeData}对象 具体解析结果以 {@link com.smarthome.head.SmartHomeData}的code值为准。
     */
